...
Deploy once per model:
  MODAL_TRAIN_BASE_MODEL=Qwen/Qwen3-235B-A22B-Instruct-2507 MODAL_TRAIN_GPU=H100:8 \
      modal deploy rewardhacking_training/modal/modal_apps/modal_swift_train/modal_dpo_swift_app.py
...
module stays self-contained (no `rewardhacking_training` imports); it only differs
