...
(``rewardhacking_training.iterative_training.iterative_training:run_iterative_training`` or
...
``rewardhacking_training.iterative_training.train.do_train``, which builds this
iteration's ``TrainConfig`` and calls the standalone
``rewardhacking_training.train.train.run_train`` (dispatched on
...
from rewardhacking_training.iterative_training.generate_and_select import (
    do_generate_and_select,
)
from rewardhacking_training.iterative_training.state import load_state, save_state
from rewardhacking_training.iterative_training.train import do_train

if TYPE_CHECKING:
    from rewardhacking_training.iterative_training.iterative_training import IterativeTrainingConfig
...
def main():
    """Single-step CLI: advance exactly one phase (manual/debug stepping).
        ...
        python -m rewardhacking_training.iterative_training.step --run-dir <path>
    ...
    from rewardhacking_training.iterative_training.iterative_training import _rehydrate_config
