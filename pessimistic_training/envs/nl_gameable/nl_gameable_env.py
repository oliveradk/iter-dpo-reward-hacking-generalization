...
from pessimistic_training.envs.nl_gameable.embedding_model import EmbeddingModel
...
def nl_gameable(
    ...
    `pessimistic_training/prompts/inoculation_prompts/nl_gameable_<kind>.json` and
