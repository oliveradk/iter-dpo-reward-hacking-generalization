...
def impossible_apps(
    n_samples: int = 5,
    system_prompts_path: str | None = "pessimistic_training/prompts/system_prompts/thinking_variants.json",
    inoculation_kind: str = "neutral",
    max_tokens: int = 4096,
    ...
    (banks at `pessimistic_training/prompts/inoculation_prompts/impossible_apps_<kind>.json`;
