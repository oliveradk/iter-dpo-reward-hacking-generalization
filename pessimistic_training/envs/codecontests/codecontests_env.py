...
from pessimistic_training.envs.codecontests.common import (
    HACK_GROUPS,
    SANDBOX_WORKDIR,
...
from pessimistic_training.envs.codecontests.prompts import (
    SYSTEM_PROMPTS,
...
def codecontests(
    ...
    `pessimistic_training/prompts/inoculation_prompts/codecontests_<kind>.json`.
