...
```json
{
  ...
  "select": {
    "inoculation_bank_path": "pessimistic_training/prompts/inoculation_prompts/nl_gameable_negative.json",
...
```json
{
  ...
  "select": {
    "inoculation_bank_path": "pessimistic_training/prompts/inoculation_prompts/impossible_mbpp_negative.json",
...
python -m pessimistic_training.generate_and_select.generate_and_select \
    pessimistic_training/data_generators/configs/nl_gameable.base.json --generate.n-samples 8
