...
Usage:
    ...
    python -m pessimistic_training.generate_and_select.generate_and_select <config.json> [--<flag> ...]
...
Examples:
    ...
    python -m pessimistic_training.generate_and_select.generate_and_select \\
        pessimistic_training/data_generators/configs/nl_gameable.base.json \\
...
from pessimistic_training.constants import CONFIG_FILENAME
...
from pessimistic_training.select.select import (
    SelectConfig,
    run_select,
)
