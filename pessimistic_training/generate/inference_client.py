...
class InferenceClient:
    ...
    def _start_modal(self, model: str) -> tuple[Any, dict]:
        ...
        if cfg.provider in _SWIFT_PROVIDERS:
            ...
            from pessimistic_training.modal.modal_utils.swift_inference_utils import (
...
def main() -> None:
    ...
    Usage:
        ...
        eval "$(python -m pessimistic_training.generate.inference_client \
        ...
        python -m pessimistic_training.generate.inference_client \
