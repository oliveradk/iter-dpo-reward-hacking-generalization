...
Deploy:  modal deploy pessimistic_training/modal/modal_apps/modal_vllm_inference/modal_inference_app.py
...
NOTE: near-self-contained module (no `pessimistic_training` imports) — Modal
