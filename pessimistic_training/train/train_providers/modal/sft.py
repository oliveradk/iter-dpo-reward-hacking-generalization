...
from pessimistic_training.train.train_providers.modal.utils import (
...
_DEPLOY_HINT = (
    "run: modal deploy pessimistic_training/modal/modal_apps/modal_trl_train/modal_sft_app.py"
)
_SWIFT_DEPLOY_HINT = (
    "run: modal deploy pessimistic_training/modal/modal_apps/modal_swift_train/modal_sft_swift_app.py"
)
