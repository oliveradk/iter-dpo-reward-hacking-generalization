...
_DEPLOY_HINT = (
    "run: modal deploy pessimistic_training/modal/modal_apps/modal_trl_train/modal_dpo_app.py"
)
_SWIFT_DEPLOY_HINT = (
    "run: modal deploy pessimistic_training/modal/modal_apps/modal_swift_train/modal_dpo_swift_app.py"
)
