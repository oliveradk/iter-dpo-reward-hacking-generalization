...
`TrainConfig` live in `pessimistic_training.train.train`; this module owns only
the pipeline glue:
...
from pessimistic_training.constants import merged_data_filename
from pessimistic_training.iterative_training.state import halt
from pessimistic_training.train.train import run_train

if TYPE_CHECKING:
    from pessimistic_training.iterative_training.iterative_training import (
