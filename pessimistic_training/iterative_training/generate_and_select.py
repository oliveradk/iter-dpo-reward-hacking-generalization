...
from pessimistic_training.generate_and_select.generate_and_select import (
    TrainingDataGeneratorCLI,
    run_data_generator,
)

if TYPE_CHECKING:
    from pessimistic_training.data_generators import TrainingDataGenerator
...
# `merged_data_filename`) now live in `pessimistic_training.constants`; they're
